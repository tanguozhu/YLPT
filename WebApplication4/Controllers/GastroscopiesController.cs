    ...
    public class GastroscopiesController : Controller
    {
            ...
            "Checknum,Conclusion,Pathologynum,Pathologyconclusion,Pic1,Pic2,Pic3,Pic4,Pic5")] Gastroscopy gastroscopy)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                sql = " INSERT INTO gastroscopy (checkname,scannum,visit,checktime,checknum,conclusion,pathologynum,pathologyconclusion,other,pic1,pic2,pic3,pic4,pic5,pic6,pic7,pic8)" +
                    ...
                    gastroscopy.Pic7 + "','" + gastroscopy.Pic8+ "')";
